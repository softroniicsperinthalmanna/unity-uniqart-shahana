...
class NeedyUniformDetailPage extends StatefulWidget {
  NeedyUniformDetailPage({Key? key,required this.tagID,
    required this.pid,
    required this.nid,
    required this.size,required this.sub,required this.description,required this.stock,required this.image,required this.donorID}) : super(key: key);
  ...
  @override
  State<NeedyUniformDetailPage> createState() => _NeedyUniformDetailPageState();
}

class _NeedyUniformDetailPageState extends State<NeedyUniformDetailPage> {
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                      ...
                      child: Image.network('${Con.url}donateclothUploads/${widget.image}',fit: BoxFit.cover,)
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text('${widget.sub}',style: descStyle,),
                ),
                ...
                Padding(
                  ...
                  padding: const EdgeInsets.all(8.0),
                  child: Text('${widget.size}',style: descStyle,),
                ),
                //  Spacer(),
                ButtonBar(
                  children: [
