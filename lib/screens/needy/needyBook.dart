...
import 'needyBookDetailPage.dart';
class DonatedBook extends StatefulWidget {

   DonatedBook({Key? key,required this.nid}) : super(key: key);
  var nid;
  @override
  State<DonatedBook> createState() => _DonatedBookState();
}

class _DonatedBookState extends State<DonatedBook> {
  var flag=0;
  Future<dynamic> getBook()  async {

    // var url = "http://192.168.180.139/uniqart_app/viewArt.php";
    var response = await http.get(Uri.parse("${Con.url}viewDonateBook.php"));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              itemBuilder:(BuildContext context,int index) {
                ...
                return InkWell(
                  onTap: (){
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>NeedyBookDetailPage(

                        name: list[index]['name'],
                        author: list[index]['author'],
                        publishDate: list[index]['year'],
                            ...
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  child: Image(image: NetworkImage("${Con.url}donatebookUploads/${list[index]['image']}",),fit: BoxFit.cover,),
                                  // child:
                                  // Center(
                                  //   child: Text(
      ...
      //                         child: Center(child: Text(list[index]['name'],style: TextStyle(color:Colors.white,fontWeight: FontWeight.bold),)),
      //
      //                       ),
      //                     )
      //                   ]
