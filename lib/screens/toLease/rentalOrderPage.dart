...
//   RentalOrderPage({Key? key,required this.vid}) : super(key: key);
//   var vid;
//   @override
...
//
//     var response =
//     await post(Uri.parse('${Con.url}viewOrdersBySeller.php'), body: data);
//     print(response.body);
...
//
//     var response =
//     await post(Uri.parse('${Con.url}updateOrderSeller.php'), body: data);
//     print(response.body);
//     print(response.statusCode);
//     if (response.statusCode == 200) {
