...
class AddDressDetails extends StatefulWidget {
  AddDressDetails({Key? key, required this.indexNo,required this.rid}) : super(key: key);
  var indexNo,rid;
  @override
  _AddDressDetailsState createState() => _AddDressDetailsState();
}

var type;

class _AddDressDetailsState extends State<AddDressDetails> {
  @override
  void initState() {
    super.initState();
    switch(widget.indexNo){
      case 0: clothType='Lehanga';
      break;
      case 1: clothType='Ethnic Wear';
      break;
      case 2: clothType='Saree';
      break;
      case 3: clothType='Gown';
      break;
      case 4: clothType='Sharara';
      break;
  ...
  Future upload(File imageFile) async {
    ...
    var uri = Uri.parse("${Con.url}addDress.php");

    var request = http.MultipartRequest("POST", uri);
    request.fields['clothName'] = name.text;
    request.fields['clothType'] = clothType;
