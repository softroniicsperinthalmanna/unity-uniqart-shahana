...
class ProductsPage_jewel extends StatefulWidget {
  ProductsPage_jewel({Key? key,required this.rid,required this.cat}) : super(key: key);
  var rid;

  var cat;
  @override
  State<ProductsPage_jewel> createState() => _ProductsPage_jewelState();
}

class _ProductsPage_jewelState extends State<ProductsPage_jewel> {
  var flag;
  var pid;
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                  ...
                                  child: Image.network(
                                    '${Con.url}jewelUploads/${snapshot.data[index]['image']}',
                                    fit: BoxFit.fill,
                                  )),
                            ),
