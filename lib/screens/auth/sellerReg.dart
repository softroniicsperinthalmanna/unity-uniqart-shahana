...
class SellerReg extends StatefulWidget {
  SellerReg({Key? key}) : super(key: key);
 // var userType;
  @override
  State<SellerReg> createState() => _SellerRegState();
}
...
class _SellerRegState extends State<SellerReg> {
  ...
  Future<void> signUp() async {
    ...
    var response= await post(Uri.parse('${Con.url}sellerReg.php'),body: data);
    print(response.body);
    ...
    return Scaffold(
      ...
      // ),
        body:Padding(
          ...
          child: ListView(
            children: [
              Center(child: Text('Create Seller Account',style:authHead,)),
              SizedBox(height: 20,),
