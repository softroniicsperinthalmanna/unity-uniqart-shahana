...
print(data);
    ...
    // categoryCount=jsonDecode(response.body)['catCount'];
     orders=jsonDecode(response.body)['ordercount'].toString();
    users=jsonDecode(response.body)['usercount'].toString();
    pdts=jsonDecode(response.body)['productcount'].toString();
     print(orders);
     print(users);
     print(pdts);
        ...
        body: Padding(
          ...
          child: ListView(
            children: [
              ...
              InkWell(
                onTap: (){
                 Navigator.push(context, MaterialPageRoute(builder: (context)=>OrderPage(vid: widget.logId,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // orders==''?Text('0',style: dashStyle,):Text(orders,style: dashStyle,),
                    ],
                  ),
                ),
              ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // users==''?Text('0',style: dashStyle,):Text(users,style: dashStyle,),
                    ],
                  ),
                ),
              ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // pdts==''?Text('0',style: dashStyle,):Text(pdts,style: dashStyle,),
                    ],
                  ),
                ),
              ),
