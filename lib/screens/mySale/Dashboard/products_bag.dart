...
class ProductsPage_bag extends StatefulWidget {
  ProductsPage_bag({Key? key,required this.vid,required this.cat}) : super(key: key);
  var vid;

  var cat;
  @override
  State<ProductsPage_bag> createState() => _ProductsPage_bagState();
}

class _ProductsPage_bagState extends State<ProductsPage_bag> {
  var flag;
  var pid;
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                  ...
                                  child: Image.network(
                                    '${Con.url}bagUploads/${snapshot.data[index]['image']}',
                                    fit: BoxFit.fill,
                                  )),
                            ),
                            Padding(
