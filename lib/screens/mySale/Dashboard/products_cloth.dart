...
class ProductsPage_cloth extends StatefulWidget {
  ProductsPage_cloth({Key? key,required this.vid,required this.cat}) : super(key: key);
  var vid;

  var cat;
  @override
  State<ProductsPage_cloth> createState() => _ProductsPage_clothState();
}

class _ProductsPage_clothState extends State<ProductsPage_cloth> {
  var flag;
  var pid;
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                  ...
                                  child: Image.network(
                                    '${Con.url}clothUploads/${snapshot.data[index]['image']}',
                                    fit: BoxFit.fill,
                                  )),
                            ),
                            Padding(
