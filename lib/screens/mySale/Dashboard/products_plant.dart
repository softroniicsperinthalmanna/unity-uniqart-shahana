...
class ProductsPage_plant extends StatefulWidget {
  ProductsPage_plant({Key? key,required this.vid,required this.cat}) : super(key: key);
  var vid;

  var cat;
  @override
  State<ProductsPage_plant> createState() => _ProductsPage_plantState();
}

class _ProductsPage_plantState extends State<ProductsPage_plant> {
  var flag;
  var pid;
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                  ...
                                  child: Image.network(
                                    '${Con.url}plantUploads/${snapshot.data[index]['image']}',
                                    fit: BoxFit.fill,
                                  )),
                            ),
                            Padding(
