...
class AddClothDetails extends StatefulWidget {
  AddClothDetails({Key? key, required this.indexNo,required this.vid}) : super(key: key);
  var indexNo,vid;
  @override
...
class _AddClothDetailsState extends State<AddClothDetails> {
  ...
  void initState() {
    ...
    switch(widget.indexNo){
      case 0: clothType='Frock';
      break;
      case 1: clothType='Shirt';
      break;
      case 2: clothType='Pants';
      break;
      case 3: clothType='Top';
      break;
      case 4: clothType='Kurthi';
      break;
