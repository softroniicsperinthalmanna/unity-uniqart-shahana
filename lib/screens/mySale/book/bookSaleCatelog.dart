...
class BookSaleCatelog extends StatefulWidget {
   BookSaleCatelog({Key? key,required this.vid}) : super(key: key);
var vid;
  @override
  State<BookSaleCatelog> createState() => _BookSaleCatelogState();
}

class _BookSaleCatelogState extends State<BookSaleCatelog> {
  @override
