...
import 'package:uniqartapp/models/plantmodel.dart';
...
import 'addPlantDetails.dart';
class PlantSaleCatelog extends StatefulWidget {
   PlantSaleCatelog({Key? key,required this.vid}) : super(key: key);
var vid;
  @override
  State<PlantSaleCatelog> createState() => _PlantSaleCatelogState();
}

class _PlantSaleCatelogState extends State<PlantSaleCatelog> {
  @override
                  ...
                  return Padding(
                    ...
                    child: InkWell(
                      onTap: (){
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>AddPlantDetails(
                          indexNo: index,vid: widget.vid,
                        )));
                      },
                      child: Container(
                        height: 170,
