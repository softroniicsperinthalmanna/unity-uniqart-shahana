...
import 'addArtDetails.dart';
class ArtSaleCatelog extends StatefulWidget {
   ArtSaleCatelog({Key? key,required this.vid}) : super(key: key);
var vid;
  @override
  State<ArtSaleCatelog> createState() => _ArtSaleCatelogState();
}

class _ArtSaleCatelogState extends State<ArtSaleCatelog> {
  @override
                ...
                childCount:artCatelog.length,
                  ...
                  return Padding(
                    ...
                    child: InkWell(
                      onTap: (){
                        print(index);
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>AddArtDetails(
