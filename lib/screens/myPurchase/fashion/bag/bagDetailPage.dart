...
class BagDetailPage extends StatefulWidget {
  BagDetailPage({Key? key,required this.tagID,required this.logID,required this.pid,required this.vid,required this.name,required this.rate,required this.size,required this.material,required this.description,required this.stock,required this.image}) : super(key: key);
var name;
var rate;
var description;
var stock;
...
void initState(){
  ...
  // print(widget.rate);
  // print(widget.image);
  print("tagId : ${widget.tagID}");
  print("name : ${widget.name}");
  print("stock : ${widget.stock}");
  print("size : ${widget.size}");
  print("rate : ${widget.rate}");
  print("size : ${widget.size}");
  print("material : "+widget.material);
  print(widget.image);
  print("My ID inside Cloth detail Page : "+widget.logID);
}
            ...
            child: Column(
              ...
              children: [
               ...
               color: Color(0xffa2e7ef),
                child: Image.network('${Con.url}bagUploads/${widget.image}',fit: BoxFit.cover,)
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
               ...
               Padding(
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(' ${widget.material}',style: heading1,),
                ),
