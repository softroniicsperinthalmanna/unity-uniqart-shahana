...
class BagDetailPage extends StatefulWidget {
  BagDetailPage({Key? key,required this.tagID,required this.name,required this.rate,required this.size,required this.material,required this.description,required this.stock,required this.image}) : super(key: key);
var name;
var rate;
var description;
var stock;
