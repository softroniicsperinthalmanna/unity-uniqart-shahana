...
class ClothDetailPage extends StatefulWidget {
  ClothDetailPage({Key? key,required this.logID,required this.pid,required this.vid,required this.tagID,required this.rate,required this.name,required this.size,required this.material,required this.description,required this.stock,required this.image}) : super(key: key);
var logID;
  var rate;
var description;
var stock;
...
void initState(){
  ...
  print(widget.image);
  ID=widget.logID;
  print("My ID inside Cloth detail Page : "+ID);
}
            ...
            child: Column(
              ...
              children: [
               ...
               color: Color(0xffa2e7ef),
                child: Image.network('${Con.url}clothUploads/${widget.image}',fit: BoxFit.fill,)
                  ),
                ),
               Padding(
                 padding: const EdgeInsets.all(8.0),
