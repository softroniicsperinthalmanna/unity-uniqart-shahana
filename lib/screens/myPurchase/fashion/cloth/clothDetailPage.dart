...
class ClothDetailPage extends StatefulWidget {
  ClothDetailPage({Key? key,required this.logID,required this.tagID,required this.rate,required this.name,required this.size,required this.material,required this.description,required this.stock,required this.image}) : super(key: key);
var logID;
  var rate;
var description;
var stock;
