...
class MyNotificaions extends StatefulWidget {
   MyNotificaions({Key? key,required this.logID}) : super(key: key);
var logID;
  @override
  State<MyNotificaions> createState() => _MyNotificaionsState();
}

class _MyNotificaionsState extends State<MyNotificaions> {
  var cartID;
  var flag;
  Future<dynamic> getData() async {
    ...
    var response=await post(Uri.parse('${Con.url}myNotification.php'),body:data);
    print(response.body);
                    ...
                    return Padding(
                      ...
                      ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                             Text('Message From  :#${snapshot.data[index]['msg_from'].toString()}'),
                             Text('ProductID :#${snapshot.data[index]['pid'].toString()}'),

                            Text('Payment: Rs ${snapshot.data[index]['tot'].toString()} /-'),
                            Divider(),
