...
// class RentalPurchaseSingle extends StatefulWidget {
//   RentalPurchaseSingle({Key? key,required this.indexNo}) : super(key: key);
//   var indexNo;
//
//   @override
//   State<RentalPurchaseSingle> createState() => _RentalPurchaseSingleState();
// }
//
// class _RentalPurchaseSingleState extends State<RentalPurchaseSingle> {
//   var category;
//   Future viewBook() async {
//     switch(widget.indexNo){
//       case 0: category='jewellery';break;
//
//       default: category='dress';break;
//     }
//     var data={
//
//       'category':category
...
//     var response = await http.post(Uri.parse("${Con.url}viewJewellery.php"),body: data);
//     print(response.body);
//
