...
class BookDetailPage extends StatefulWidget {
  BookDetailPage({Key? key,required this.tagID,required this.logID,required this.pid,required this.vid,required this.name,required this.rate,required this.description,required this.stock,required this.author,required this.year,required this.image}) : super(key: key);
var rate;
var name;
var description;
var stock;
            ...
            child: Column(
              ...
              children: [
               ...
               color: Color(0xffa2e7ef),
                child: Image.network('${Con.url}bookUploads/${widget.image}',fit: BoxFit.cover,)
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(' ${widget.author}',style: heading1,),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(' ${widget.year}',style: heading1,),
                ),
