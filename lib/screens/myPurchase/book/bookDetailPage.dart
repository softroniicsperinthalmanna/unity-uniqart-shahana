...
class BookDetailPage extends StatefulWidget {
  BookDetailPage({Key? key,required this.tagID,required this.name,required this.rate,required this.description,required this.stock,required this.image}) : super(key: key);
var rate;
var name;
var description;
var stock;
