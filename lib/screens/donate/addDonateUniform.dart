...
class AddDonateUniformDetails extends StatefulWidget {
  AddDonateUniformDetails({Key? key,required this.did}) : super(key: key);
var did;
  @override
  _AddDonateUniformDetailsState createState() => _AddDonateUniformDetailsState();
}
var type;
class _AddDonateUniformDetailsState extends State<AddDonateUniformDetails> {
  @override
  void initState(){
    super.initState();
