...
class AddDonateBookDetails extends StatefulWidget {
  AddDonateBookDetails({Key? key,required this.indexNo,required this.did}) : super(key: key);
  var indexNo;
  var did;
  @override
  _AddDonateBookDetailsState createState() => _AddDonateBookDetailsState();
}

class _AddDonateBookDetailsState extends State<AddDonateBookDetails> {
  @override
  void initState(){
    super.initState();
  ...
  Future upload(File imageFile)async{
    ...
    var uri = Uri.parse("${Con.url}addDonateBook.php");
  ...
  //  request.fields['bookType'] = category;
    ...
    request.fields['publishYear'] = publishYear.text;
